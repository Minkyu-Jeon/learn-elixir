defmodule UrlShortenerWeb.CMS.PageController do
  use UrlShortenerWeb, :controller

  alias UrlShortener.CMS
  alias UrlShortener.CMS.Page

  plug :require_existing_author
  plug :authorize_path when action in [:edit, :update, :delete]
  ...
  defp authorize_path(conn, _) do
    ...
    if conn.assigns.current_author.id == page.author_id do
      ...
      conn
      |> put_flash(:error, "You cant't modify that page")
      |> redirect(to: Routes.cms_page_path(conn, :index))
      |> halt()
    end
  end
